...
<template>
  <div>
    ...
    <p-section v-if="page.about_como_construimos" class="section-1">
      ...
      <b-row>
        <b-col v-if="page.about_analise_fundamentos" cols="12" md="4" v-html="page.about_analise_fundamentos" />
        <b-col v-if="page.about_estruturacao_fidc" cols="12" md="4" v-html="page.about_estruturacao_fidc" />
        <b-col v-if="page.about_revisao_monitoramento" cols="12" md="4" v-html="page.about_revisao_monitoramento" />
      </b-row>
    </p-section>

    <p-section class="section-2">
      <b-row>
        <b-col cols="12" md="7" class="column-image left" offset-md="1">
          <span
      ...
      <b-row>
        <b-col cols="12" md="2" offset-md="10">
          <p-colors-bars />
        </b-col>
      </b-row>
    </p-section>
    ...
    <p-section class="section-3">
      <b-row>
        ...
        <b-col cols="12" md="6" class="column-image right">
          <span
    ...
    <p-section class="section-4">
      <b-row>
        ...
        <b-col cols="12" md="1" />
        <b-col cols="12" md="5" class="column-image right">
          <span
